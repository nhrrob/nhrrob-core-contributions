...
$hide_on_admin = ! $is_shortcode ? '' : 'hidden';
...
<!-- ToDo Add separate page for settings -->

<div class="wrap p-6 max-w-4xl mx-auto <?php echo esc_attr( $hide_on_shortcode ); ?> <?php echo esc_attr( $hide_on_admin ); ?>">
...
<div class="<?php echo esc_attr($styles['wrapper']); ?> <?php echo esc_attr( $hide_on_admin ); ?>">
